...
- **Immutable [collections]({{ "/en/glossary/collections/" | relative_url }})** — [`List`]({{ "/en/glossary/list/" | relative_url }}), [`Set`]({{ "/en/glossary/sets/" | relative_url }}), [`Map`]({{ "/en/glossary/maps/" | relative_url }}) expose no mutation methods. [`MutableList`]({{ "/en/glossary/mutable-list/" | relative_url }}), [`MutableSet`]({{ "/en/glossary/mutable-set/" | relative_url }}), [`MutableMap`]({{ "/en/glossary/mutable-map/" | relative_url }}) add them.
