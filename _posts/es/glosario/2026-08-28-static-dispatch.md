...
tags: [dispatch, compiler, performance]
lang: es
...
- El static dispatch tiene cero overhead — sin lookup de [vtable]({{ "/es/glosario/vtable/" | relative_url }}), sin indirección. Por eso las [extension functions]({{ "/es/glosario/extension-functions/" | relative_url }}) son tan rápidas como métodos estáticos de utilidad regulares.
- Las funciones de [companion object]({{ "/es/glosario/companion-object/" | relative_url }}), funciones top-level y métodos [`@JvmStatic`]({{ "/es/glosario/jvm-static/" | relative_url }}) también usan static dispatch. Entender qué llamadas son estáticas vs. [virtuales]({{ "/es/glosario/virtual-dispatch/" | relative_url }}) es esencial para razonar sobre performance y correctitud en Kotlin.
