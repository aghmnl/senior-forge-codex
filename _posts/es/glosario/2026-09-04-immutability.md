...
- **[Colecciones]({{ "/es/glosario/collections/" | relative_url }}) inmutables** — `List`, `Set`, `Map` no exponen métodos de mutación. `MutableList`, `MutableSet`, `MutableMap` los agregan.
